							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
										    ...
										    <div class="item-data" style="border-radius: 50%;background-repeat: no-repeat;background-size: cover;"><img class="profile-image" src="assets/uploads/<?php echo $row['image'] ?>" alt=""></div>
									    </div><!--//col-->
